...
As a member of the team that manages **traefik-block-regex-urls**, you have the following responsibilities:
...
- **Changes to build scripts, guidelines and things that might break the processes we have in place need to be reviewed by [@shantanugadgil](https://github.com/shantanugadgil/)** (this is temporary, but we need a baseline to make sure we break as few things as possible in the beginning).
